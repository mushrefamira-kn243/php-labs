<?php
/**
 * Shared layout template for LR2 Variant 8 task pages
 */
...
function renderVariantLayout(string $content, string $taskName, string $bodyClass = ''): void
{
    ...
    $demoUrl = "/lr2/demo/{$currentTask}?from=v8";
    ?>
<!DOCTYPE html>
<html lang="uk">
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($taskName) ?> — Варіант 8 ЛР2</title>
...
<body class="body-with-header <?= htmlspecialchars($bodyClass) ?>">
    <header class="header-fixed">
        ...
        <div class="header-right">
            <span class="header-variant-label">В-8 (ЛР2)</span>
